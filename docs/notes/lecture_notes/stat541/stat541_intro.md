...
### [[stat541_week2#Week 2|Week 2]]

Concepts:  Empirical risk minimization, bias-variance decomposition. 

References: For the bias-variance decomposition see *Introduction to Statistical Learning with R* (ISLR)[^2] Section 2.2 and *Elements of Statistical Learning* (ESL)[^3] Section 7.3. In particular, equation (7.9) of ESL is essentially the bias-variance decomposition we derived in class, except that we also took an expectation over $x_0$. 

[^2]: G. James, D. Witten, T. Hastie, and R. Tibshirani, An introduction to statistical learning: with applications in R, Second edition. in Springer texts in statistics. New York: Springer, 2021.
[^3]: T. Hastie, R. Tibshirani, and J. Friedman, The Elements of Statistical Learning. in Springer Series in Statistics. New York, NY: Springer New York, 2009. doi: 10.1007/978-0-387-84858-7.


### [[stat541_week3#Week3|Week 3]]
...
### [[stat541_week10#Week 10|Week 10]]
...
### [[stat541_week11#Week 11|Week 11 - Guest Lecture]]
...
### [[stat541_week12#Week 12|Week 12]]
...
References: ISLR 12.4, 14.4.1-14.3.6, 14.3.12. Neither ISLR or ESL has an extensive discussion on GMM. For this, see Section 9.2, *Pattern Recognition and Machine Learning*[^4]. 

[^4]: By Christopher M. Bishop (2006).   

### [[stat541_week13#Week 13|Week 13]]

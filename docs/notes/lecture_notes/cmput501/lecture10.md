...
[Scribe10.pdf](https://shx-haah.github.io/notes/lecture_notes/cmput501/Scribe10.pdf)
...
This is equivalent to the coupon collector's problem ([[lecture7#Lecture 7|Section 6.5]]), where the expected time to collect all $n$ coupons is $\Theta(n\log n)$.